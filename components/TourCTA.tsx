    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-[#1e3d2f]/88" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(200,146,42,0.12),_transparent_70%)]" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10 text-center">
        ...
        <h2 className="font-display text-5xl md:text-7xl font-light text-white leading-tight mb-6 text-balance">
          Come see it{" "}
          <em className="text-[#e8c87a]">for yourself.</em>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#e8c87a] text-[#2a2015] font-semibold px-10 py-4 rounded-full hover:bg-[#f5e4b8] transition-all text-base tracking-wide shadow-lg shadow-black/30"
          >
            Schedule a Tour
