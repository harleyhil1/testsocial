      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl shadow-[#00205b]/15">
              <Image
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#00205b]/40 to-transparent" />
            </div>
            {/* Address card overlay */}
            <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl p-5 shadow-lg">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#00205b] flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <div className="font-semibold text-[#00205b] text-sm">Montessori Academy</div>
                  <div className="text-[#5a7090] text-sm mt-0.5">6050 N Invergordon Rd</div>
                  <div className="text-[#5a7090] text-sm">Paradise Valley, AZ 85253</div>
                  <a href="tel:4809451121" className="text-[#c8a050] text-sm font-medium mt-1 block hover:underline">
                    (480) 945-1121
                  </a>
                </div>
              </div>
            ...
            {/* Accent */}
            <div className="absolute -top-5 -right-5 w-28 h-28 bg-[#c8a050]/10 rounded-2xl -z-10" />
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 bg-[#00205b] text-white font-semibold px-8 py-4 rounded-full hover:bg-[#003087] transition-all text-sm tracking-wide"
              >
                Schedule a Visit
              </Link>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 border border-[#dce4f2] text-[#4a3f30] font-medium px-8 py-4 rounded-full hover:border-[#00205b] transition-all text-sm"
              >
                Get Directions
