        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            ...
            >
              ...
              {/* Author */}
              <div className="flex items-center gap-4 pt-6 border-t border-[#dce4f2]">
                <div className="w-10 h-10 rounded-full bg-[#00205b] flex items-center justify-center text-[#e8c878] font-display font-semibold text-lg">
                  {t.initial}
                </div>
                <div>
                  <div className="text-[#00205b] font-semibold text-sm">{t.author}</div>
                  <div className="text-[#5a7090] text-xs">{t.role}</div>
                </div>
              </div>
            </div>
          ))}
