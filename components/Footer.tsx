...
export default function Footer() {
  return (
    <footer className="bg-[#001540] text-white/70">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-white/10">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              <Logo size={36} color="#e8c878" />
              <div>
                <div className="font-display text-lg font-semibold text-white leading-none">
                  Montessori Academy
                </div>
                <div className="text-[10px] text-[#e8c878]/60 uppercase tracking-[0.2em] mt-0.5">
            ...
            <div className="mt-6 space-y-2 text-sm">
              <div className="flex items-start gap-2">
                <svg className="mt-0.5 flex-shrink-0 text-[#e8c878]/60" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0zM19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                </svg>
                <span>6050 N Invergordon Rd<br />Paradise Valley, AZ 85253</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="flex-shrink-0 text-[#e8c878]/60" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
